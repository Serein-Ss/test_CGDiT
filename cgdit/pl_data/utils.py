...
def load_envs(env_file: Optional[str] = None) -> None:
    """
    Load all environment variables defined in the `env_file`.
    This is equivalent to `. env_file` in the bash.
...
def log_hyperparameters(
    ...
    Additionally saves:
        - sizes of train, val, test_data dataset
    ...
    hparams[f"{STATS_KEY}/params_not_trainable"] = sum(p.numel()
